...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item \mintinline{cpp}|CHAR_BIT| impérativement égal à 8 (\textit{\fg{}There are exactly 8 bits in a byte\fg{}})
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Données statiques dans les classes locales non nomées
	\end{itemize}

	\addproposal{p3421}{https://wg21.link/p3421r0}
	\addproposal{p3588}{https://wg21.link/p3588r0}
\end{frame}
...
\begin{frame}[fragile]
	\frametitle{\mintinline[style=white]{cpp}|std::optional| \& \mintinline[style=white]{cpp}|std::optional|}
	\begin{itemize}
