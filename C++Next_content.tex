...
\begin{frame}[fragile]
	...
	\propthree{p2660}{https://wg21.link/p2660r0}
		{P2900}{https://wg21.link/P2900R1}
		{P2961}{https://wg21.link/P2961R1}
\end{frame}
...
\note[item]{\mintinline{cpp}|enforce| : c'est un arrêt systématique, \mintinline{cpp}|observe| : on laisse le \textit{handler} décider}
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{n4771}{https://wg21.link/n4771}
		{P2762}{https://wg21.link/P2762R2}
\end{frame}
...
\note[item]{Proche dans l'esprit de \mintinline{cpp}|switch/case| avec une syntaxe plus légère et sans \textit{fallthrough}}
		\end{itemize}
	\end{itemize}
	...
	\prop{P1371}{https://wg21.link/p1371r3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N4617}{https://wg21.link/n4617}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N4948}{https://wg21.link/n4948}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N4808}{https://wg21.link/n4808}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P0159}{https://wg21.link/p0159r0}
		{N4953}{https://wg21.link/n4953}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{N4514}{https://wg21.link/n4514}
		{N4956}{https://wg21.link/n4956}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{N4856}{https://wg21.link/n4856}
		{P1240}{https://wg21.link/p1240r2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{p2795}{https://wg21.link/p2795r3}
		{p2973}{https://wg21.link/p2973r0}
\end{frame}
...
\note[item]{P.ex. une structure de deux \mintinline{cpp}|float| et un tableau de deux \mintinline{cpp}|float|}
...
\note[item]{\textit{automatic storage duration}, c'est ce qui est sur la pile, donc globalement les variables locales}
	...
	\propthree{P3003}{https://wg21.link/P3003R0}
		{P3018}{https://wg21.link/P3018R0}
		{p2966}{https://wg21.link/p2966r1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propthree{P2980}{https://wg21.link/P2980R0}
		{P2981}{https://wg21.link/P2981R0}
		{P2982}{https://wg21.link/P2982R0}
\end{frame}
...
\note[item]{Objets respectant la règle du 0 (pas de définition utilisateur de constructeur de copie/déplacement, d'opérateur d'affection par copie/déplacement ni de destructeur)}
	...
	\propthree{P1144}{https://wg21.link/P1144R9}
		{P2786}{https://wg21.link/P2786R3}
		{P2967}{https://wg21.link/P2967R0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2951}{https://wg21.link/P2951R3}
\end{frame}
...
\note[item]{En pratique, fonctionne déjà mais n'est pas normalisé}
	...
	\prop{P2968}{https://wg21.link/P2968R0}
\end{frame}
...
\note[item]{Alignement sur des évolutions C en cours}
	...
	\prop{P2881}{https://wg21.link/p2881r0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2806}{https://wg21.link/p2806r1}
\end{frame}
...
\note[item]{L'idée est de traiter le \mintinline{cpp}|static_assert| à l'instanciation et donc de n'échouer que si le paramètre template n'est convertible ni en entier ni en chaîne}

	\prop{P2593}{https://wg21.link/p2593r1}
\end{frame}
...
\note[item]{Optimisation déjà réalisée par certains compilateurs}
	...
	\propthree{P3021}{https://wg21.link/p3021r0}
		{p2966}{https://wg21.link/p2966r1}
		{p1045}{https://wg21.link/p1045r1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{p2966}{https://wg21.link/p2966r1}
\end{frame}
...
\note[item]{\textit{unscoped} énumération, c'est à dire les \mintinline{cpp}|enum| par opposition aux \mintinline{cpp}|enum class|}
...
\note[item]{Interdit sur les types \textit{built-in} mais possible sur les autres, avec tous les problèmes que ça peut poser}
	...
	\prop{P2561}{https://wg21.link/p2561r2}
\end{frame}
...
\note[item]{A priori \mintinline{cpp}|operator->| et \mintinline{cpp}|operator->*| seront générés par défaut, mais cette génération sera désactivable avec \mintinline{cpp}|=delete|}
\note[item]{Dans la continuité des opérateurs de comparaisons}
	...
	\prop{P2952}{https://wg21.link/p2952r0}
\end{frame}
...
\note[item]{Similaire à l'opérateur \mintinline{cpp}|nameof| de C\# ou au trait \mintinline{cpp}|Debug| de Rust}

	\end{itemize}

	\proptwo{P2971}{https://wg21.link/p2971r1}
		{p2966}{https://wg21.link/p2966r1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2906}{https://wg21.link/p2906r0}
\end{frame}
...
\note[item]{AoS plus lisible et facile à maintenir mais SoA souvent plus efficace}
	...
	\propthree{P2763}{https://wg21.link/p2763r1}
		{P2895}{https://wg21.link/p2895r0}
		{p2966}{https://wg21.link/p2966r1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P2927}{https://wg21.link/p2927r0}
		{P1028}{https://wg21.link/p1028r5}
\end{frame}
...
\note[item]{\mintinline{cpp}|std::mdarray| possède les éléments alors que \mintinline{cpp}|std::mdspan| n'est qu'une vue et ne possède pas}
...
\note[item]{Intrusif car les mécanismes nécessaires au conteneur (p.ex. les pointeurs de chaînage des listes) sont dans l'objet que gère le conteneur, généralement via héritage}
	...
	\propfour{P1684}{https://wg21.link/p1684r5}
		{P0260}{https://wg21.link/p0260r7}
		{P0447}{https://wg21.link/p0447r23}
		{P3001}{https://wg21.link/p3001r0}
%{p2966}{https://wg21.link/p2966r1}
\end{frame}
...
\note[item]{Copies des tableaux membres en particulier}
	...
	\proptwo{P2821}{https://wg21.link/p2821r4}
		{P2767}{https://wg21.link/p2767r1}
\end{frame}
...
\note[item]{Il s'agit d'empêcher les initialisations depuis des numériques via la conversion en char}
	...
	\prop{P2591}{https://wg21.link/P2591R4}
\end{frame}
...
\note[item]{Déjà le cas pour \mintinline{cpp}|std::array|, extension aux tableaux C}
	...
	\propthree{p2527}{https://wg21.link/p2527r2}
		{p2141}{https://wg21.link/p2141r1}
		{p2819}{https://wg21.link/p2819r1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{p2727}{https://wg21.link/p2727r3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propthree{P2848}{https://wg21.link/P2848R0}
		{p1708}{https://wg21.link/p1708r7}
		{p2681}{https://wg21.link/p2681r1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{p2846}{https://wg21.link/p2846r1}
		{p2769}{https://wg21.link/p2769r1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propthree{p0870}{https://wg21.link/p0870r5}
		{p2782}{https://wg21.link/p2782r0}
		{p2985}{https://wg21.link/p2985r0}
\end{frame}
...
\note[item]{Par défaut, capture \mintinline{cpp}|const|, possible de la rendre modifiable via \mintinline{cpp}|mutable|, mais tous les données capturées sont alors mutable}
	\end{itemize}
\end{frame}
...
\note[item]{\mintinline{cpp}|std::function| peut allouer dynamiquement de la mémoire si la taille du foncteur dépasse un seuil}

		\item \mintinline{cpp}|std::function_ptr_t| : pointeur générique sur une fonction
	\end{itemize}

	\propthree{p2828}{https://wg21.link/p2828r2}
		{p2986}{https://wg21.link/p2986r0}
		{p2966}{https://wg21.link/p2966r1}
\end{frame}
...
\note[item]{Alternative à la conversion en \mintinline{cpp}|void| ou à l'affectation à \mintinline{cpp}|std::ignore|}
		\end{itemize}
	\end{itemize}

	\proptwo{p2992}{https://wg21.link/p2992r0}
		{p2966}{https://wg21.link/p2966r1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{p2994}{https://wg21.link/p2994r0}
		{p2662}{https://wg21.link/p2662r2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{p1061}{https://wg21.link/p1061r5}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propfour{p2845}{https://wg21.link/p2845r4}
		{p2945}{https://wg21.link/p2945r0}
		{p3015}{https://wg21.link/p3015r0}
		{p2930}{https://wg21.link/p2930r0}
\end{frame}
...
\note[item]{Utile pour la création de méta-fonctions template \textit{high-order}, pour avoir des \mintinline{cpp}|static_assert(false)| dépendants et pour certains tests sur les types}
	...
	\prop{p2989}{https://wg21.link/p2989r0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{p3003}{https://wg21.link/p3003r0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{p2839}{https://wg21.link/p2839r0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{p0901}{https://wg21.link/p0901r11}
\end{frame}
...
\note[item]{Pour éviter l'usage d'un objet après libération ou suppression de ces dépendances}
	...
	\proptwo{p2771}{https://wg21.link/p2771r1}
		{p2966}{https://wg21.link/p2966r1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propfour{p0493}{https://wg21.link/p0493r4}
		{p2835}{https://wg21.link/p2835r0}
% {p2689}{https://wg21.link/p2689r2}
		{p0876}{https://wg21.link/p0876r14}
% {p2019}{https://wg21.link/p2019r4}
		{p3022}{https://wg21.link/p3022r0}
% {p2966}{https://wg21.link/p2966r1}
\end{frame}
...
\note[item]{P.ex. si le standard C++2z supprime les conversions implicites, il serait possible d'appliquer ce changement uniquement sur les modules déclarant \mintinline{cpp}|epoch 202z|}
	\end{itemize}

	\prop{p2978}{https://wg21.link/p2978r0}
\end{frame}
...
\note[item]{Et sans passer par des conversions externes vers des tableaux de \textit{bytes} injectés dans un fichier d'en-tête}
	...
	\propthree{p1967}{https://wg21.link/p1967r11}
		{p2978}{https://wg21.link/p2978r0}
		{p2966}{https://wg21.link/p2966r1}
\end{frame}
\end{document}