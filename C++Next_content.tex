...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Conditions : \mintinline{cpp}|precond(...)|, \mintinline{cpp}|postcond(...)| et \mintinline{cpp}|incond(...)|
...
\begin{frame}[fragile]
	\frametitle{Ranges}
	\begin{itemize}
		\item Ajout d'un paramètre \og pas\fg{} à \mintinline{cpp}|std::iota_view|
...
\note[item]{P.ex. sur \mintinline{cpp}|realloc|}
			...
			\item \mintinline{cpp}|[[invalidate]]| : \mintinline{cpp}|ptr|, \mintinline{cpp}|*ptr| et \mintinline{cpp}|ptr->| inutilisables
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Présence de caractères d'échappement (p.ex. \mintinline{cpp}|\n|)
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item \mintinline{cpp}|std::lazy<T>| : coroutines permettant l'évaluation différée
