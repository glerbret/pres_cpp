...
\begin{frame}[fragile]
	...
	\addproposal{p2688}{https://wg21.link/p2688r5}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3695}{https://wg21.link/p3695r1}
...
\begin{frame}[fragile]
	...
	\addproposal{p3400}{https://wg21.link/p3400r1}
	\addproposal{p3831}{https://wg21.link/p3831r0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3776}{https://wg21.link/p3776r1}
\end{frame}
...
\note[item]{Auparavant obligatoirement supérieur ou égal à 8, contraint par les plages garanties de \mintinline{cpp}|signed char| et \mintinline{cpp}|unsigned char|, mais pas d'autres contraintes (même pas multiple de 8)}
	...
	\addproposal{p3666}{https://wg21.link/p3666r0}
	\addproposal{p3643}{https://wg21.link/p3643r1}
	\addproposal{P3715}{https://wg21.link/P3715R0}
	\addproposal{p3823}{https://wg21.link/p3823r0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3784}{https://wg21.link/p3784r1}
\end{frame}
...
\note[item]{A priori, \mintinline{cpp}|operator->| et \mintinline{cpp}|operator->*| générés par défaut, génération désactivable avec \mintinline{cpp}|=delete|}
	...
	\addproposal{p3834}{https://wg21.link/p3834r0}
...
\begin{frame}[fragile]
	...
	\addproposal{p3812}{https://wg21.link/p3812r0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3567}{https://wg21.link/p3567r1}
	\addproposal{P2767}{https://wg21.link/p2767r1}
	\addproposal{p3126}{https://wg21.link/p3126r3}
	\addproposal{p3127}{https://wg21.link/p3127r1}
	\addproposal{p3128}{https://wg21.link/p3128r3}
	\addproposal{p3129}{https://wg21.link/p3129r1}
	\addproposal{p3130}{https://wg21.link/p3130r3}
	\addproposal{p3131}{https://wg21.link/p3131r3}
	\addproposal{p3337}{https://wg21.link/p3337r0}
...
\begin{frame}[fragile]
	...
	\addproposal{p3779}{https://wg21.link/p3779r0}
	\addproposal{p3786}{https://wg21.link/p3786r0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3836}{https://wg21.link/p3836r0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3798}{https://wg21.link/p3798r1}
\end{frame}
...
\note[item]{Support de \mintinline{cpp}|char8_t|, \mintinline{cpp}|char16_t| et \mintinline{cpp}|char32_t|, fonction \mintinline{cpp}|constexpr|, meilleure gestion typage}
	...
	\addproposal{p3688}{https://wg21.link/p3688r3}
...
\note[item]{Ces trois fonctions sont des spécialisations \mintinline{cpp}|range::reduce()| et \mintinline{cpp}|range::transform_reduce()| pour l'addition et la multiplication}
	...
	\addproposal{p3806}{https://wg21.link/p3806r0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3719}{https://wg21.link/p3719r1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2966}{https://wg21.link/p2966r1}
	\addproposal{P3810}{https://wg21.link/p3810r0}
\end{frame}
...
\note[item]{Pour ne pas devoir déclaré \mintinline{cpp}|mutable| tous les mutex. Déjà le cas dans d'autres langages, p.ex. Rust}
	...
	\addproposal{p3832}{https://wg21.link/p3832r0}
\end{frame}
