...
\begin{frame}[fragile]
	...
	\addproposal{P2762}{https://wg21.link/P2762}
\end{frame}

\begin{frame}[fragile]
	\frametitle{TS -- Pattern matching}
	\begin{itemize}
		\item Utilisation du mot clé \mintinline{cpp}|match| (ou \mintinline{cpp}|switch|, ou \mintinline{cpp}|inspect|) et du \textit{wildcard} \mintinline{cpp}|_| (ou \mintinline{cpp}|__|)
		\item Utilisable sur
		\begin{itemize}
			\item Entiers
		\end{itemize}
	...
	\addproposal{P1371}{https://wg21.link/p1371}
	\addproposal{p2688}{https://wg21.link/p2688}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item à la sortie du scope : \mintinline{cpp}|std::scope_exit|
			\item à la sortie du scope par une exception : \mintinline{cpp}|std::scope_fail|
			\item à la sortie du scope hors exception : \mintinline{cpp}|std::scope_success|
		\end{itemize}
...
\begin{frame}[fragile]
	...
	\addproposal{P0159}{https://wg21.link/p0159}
...
\begin{frame}[fragile]
	...
	\addproposal{p3695}{https://wg21.link/p3695}
	\addproposal{p3681}{https://wg21.link/p3681}
	\addproposal{p3765}{https://wg21.link/p3765}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Comportement \mintinline{cpp}|assume| : optimisation en supposant le contrat vrai
		\item Choix du comportement dans l'assertion du contrat
		\item Contrat \textit{always-enforced}
		...
		\item Label sur les contrats
		\item Messages de diagnostic fournis par l'utilisateur
	\end{itemize}

	\addproposal{p3400}{https://wg21.link/p3400}
	\addproposal{p3831}{https://wg21.link/p3831}
	\addproposal{p3099}{https://wg21.link/p3099}
	\addproposal{p3912}{https://wg21.link/p3912}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2973}{https://wg21.link/p2973}
	\addproposal{p3232}{https://wg21.link/p3232}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3254}{https://wg21.link/p3254}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3485}{https://wg21.link/p3485}
\end{frame}

\begin{frame}[fragile]
	\frametitle{Syntaxe}
	\begin{itemize}
		\item Autorisation des \textit{trailing commas} dans davantage de contexte : paramètre de fonction, paramètres templates, \textit{structure bindings}, \ldots
	\end{itemize}

	\addproposal{p3776}{https://wg21.link/p3776}
\end{frame}
...
\note[item]{Algorithmes défini par Unicode pour travailler sur les séquences de code points}
	...
	\addproposal{p3733}{https://wg21.link/p3733}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3474}{https://wg21.link/p3474}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3412}{https://wg21.link/p3412}
	\addproposal{P0085}{https://wg21.link/P0085}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Vérification \textit{compile-time} que deux types ont la même représentation mémoire
		...
		\item \mintinline{cpp}|std::initializer_list| déplaçables
		\item Détection et gestion des débordements
		\item Gestion des arrondis
	\end{itemize}

	\addproposal{P3003}{https://wg21.link/P3003}
	\addproposal{P3018}{https://wg21.link/P3018}
	\addproposal{p2966}{https://wg21.link/p2966}
	\addproposal{p3140}{https://wg21.link/p3140}
\end{frame}

\begin{frame}[fragile]
	\frametitle{Types}
	\begin{itemize}
		\item Support obligatoire de \mintinline{cpp}|intptr_t| et \mintinline{cpp}|uintptr_t|
...
\note[item]{Auparavant obligatoirement supérieur ou égal à 8, contraint par les plages garanties de \mintinline{cpp}|signed char| et \mintinline{cpp}|unsigned char|, mais pas d'autres contraintes (même pas multiple de 8)}
		...
		\item Suppression de \mintinline{cpp}|trivially_relocatable_if_eligible| et \mintinline{cpp}|replaceable_if_eligible| et redesing de la fonctionnalité
	\end{itemize}

	\addproposal{p3248}{https://wg21.link/p3248}
	\addproposal{p3375}{https://wg21.link/p3375}
	\addproposal{p3477}{https://wg21.link/p3477}
	\addproposal{p3635}{https://wg21.link/p3635}
	\addproposal{p3639}{https://wg21.link/p3639}
	\addproposal{p3666}{https://wg21.link/p3666}
	\addproposal{p3643}{https://wg21.link/p3643}
	\addproposal{P3715}{https://wg21.link/P3715}
	\addproposal{p3823}{https://wg21.link/p3823}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p1935}{https://wg21.link/p1935}
	\addproposal{P2980}{https://wg21.link/P2980}
	\addproposal{P2981}{https://wg21.link/P2981}
	\addproposal{P2982}{https://wg21.link/P2982}
	\addproposal{p3045}{https://wg21.link/p3045}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2951}{https://wg21.link/P2951}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P3384}{https://wg21.link/p3384}
...
\note[item]{Alignement sur des évolutions C en cours}
	...
	\addproposal{P2881}{https://wg21.link/p2881}
	\addproposal{p3568}{https://wg21.link/p3568}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3784}{https://wg21.link/p3784}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2806}{https://wg21.link/p2806}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2593}{https://wg21.link/p2593}
\end{frame}
...
\note[item]{Optimisation déjà réalisée par certains compilateurs}
		...
		\item Paramètres \mintinline{cpp}|constexpr| et \textit{maybe} \mintinline{cpp}|constexpr|
		\item Fonctions \textit{heap-free}
		\item Retour \mintinline{cpp}|std::move(x)| éligible au NRVO si \mintinline{cpp}|x| l'est
	\end{itemize}

	\addproposal{P3021}{https://wg21.link/p3021}
	\addproposal{p2966}{https://wg21.link/p2966}
	\addproposal{p1045}{https://wg21.link/p1045}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2966}{https://wg21.link/p2966}
	\addproposal{p3676}{https://wg21.link/p3676}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Ajout à \mintinline{cpp}|std::source_location::current()| d'un paramètre valorisé par défaut à \mintinline{cpp}|__local_ctx|
...
\note[item]{Permet d'encapsuler \mintinline{cpp}|std::source_location::current()| tout en lui fournissant le contexte d'appel de la classe l'encapsulant}
	...
	\addproposal{p3802}{https://wg21.link/p3802}
\end{frame}
...
\note[item]{Interdit sur les types \textit{built-in} mais possible sur les autres, avec tous les problèmes que ça peut poser}
	...
	\addproposal{P2561}{https://wg21.link/p2561}
\end{frame}
...
\note[item]{A priori, \mintinline{cpp}|operator->| et \mintinline{cpp}|operator->*| générés par défaut, génération désactivable avec \mintinline{cpp}|=delete|}
	...
	\addproposal{p3834}{https://wg21.link/p3834}
	\addproposal{p3668}{https://wg21.link/P3668}
	\addproposal{P2952}{https://wg21.link/p2952}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2971}{https://wg21.link/p2971}
	\addproposal{p2966}{https://wg21.link/p2966}
\end{frame}
...
\begin{frame}[fragile]
	\frametitle{Opérateurs}
	\begin{itemize}
		\item Opérateur unaire postfixé ~ pour permuter un booléen
	\end{itemize}
	...
	\addproposal{p3883}{https://wg21.link/p3883}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2906}{https://wg21.link/p2906}
\end{frame}
...
\note[item]{AoS plus lisible et facile à maintenir mais SoA souvent plus efficace}
	...
	\addproposal{P2763}{https://wg21.link/p2763}
	\addproposal{P2895}{https://wg21.link/p2895}
	\addproposal{p2966}{https://wg21.link/p2966}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Génération par défaut des opérateurs d'affectation des classes ayant des données \mintinline{cpp}|const| ou \mintinline{cpp}|&| depuis le constructeur par copie par défaut
	\end{itemize}

	\addproposal{p3421}{https://wg21.link/p3421}
	\addproposal{p3588}{https://wg21.link/p3588}
	\addproposal{p3812}{https://wg21.link/p3812}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1028}{https://wg21.link/p1028}
\end{frame}
...
\note[item]{Intrusif car les mécanismes nécessaires au conteneur (p.ex. les pointeurs de chaînage des listes) sont dans l'objet que gère le conteneur, généralement via héritage}
			...
			\item Conteneurs \mintinline{cpp}|inplace| avec une capacité fixe
	...
	\addproposal{P1684}{https://wg21.link/p1684}
	\addproposal{P0260}{https://wg21.link/p0260}
	\addproposal{P3001}{https://wg21.link/p3001}
	\addproposal{p2966}{https://wg21.link/p2966}
	\addproposal{p3147}{https://wg21.link/p3147}
	\addproposal{p3160}{https://wg21.link/p3160}
	\addproposal{p3698}{https://wg21.link/p3698}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3567}{https://wg21.link/p3567}
	\addproposal{P2767}{https://wg21.link/p2767}
	\addproposal{p3126}{https://wg21.link/p3126}
	\addproposal{p3127}{https://wg21.link/p3127}
	\addproposal{p3128}{https://wg21.link/p3128}
	\addproposal{p3129}{https://wg21.link/p3129}
	\addproposal{p3130}{https://wg21.link/p3130}
	\addproposal{p3131}{https://wg21.link/p3131}
	\addproposal{p3337}{https://wg21.link/p3337}
	\addproposal{P3110}{https://wg21.link/p3110}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Ajout de \mintinline{cpp}|reserve()| et \mintinline{cpp}|capacity()| à \mintinline{cpp}|std::flat_map| et \mintinline{cpp}|std::flat_set|
		\item Ajout du \textit{tuple-protocol} au span de taille fixe
		\item Création de \textit{subspan} à partir d'\textit{offsets} et d'\textit{extents }\textit{compile-time}
	\end{itemize}

	\addproposal{p3049}{https://wg21.link/p3049}
	\addproposal{p3182}{https://wg21.link/p3182}
	\addproposal{p3404}{https://wg21.link/p3404}
	\addproposal{p3729}{https://wg21.link/p3729}
	\addproposal{p3737}{https://wg21.link/p3737}
	\addproposal{p3779}{https://wg21.link/p3779}
	\addproposal{p3786}{https://wg21.link/p3786}
	\addproposal{p3880}{https://wg21.link/p3880}
\end{frame}

\begin{frame}[fragile]
	\frametitle{Conteneurs}
	\begin{itemize}
		\item \mintinline{cpp}|std::is_pointer_between()| ou \mintinline{cpp}|std::is_pointer_in_range()| vérifie si un pointeur appartient à une plage mémoire
		\item
	\end{itemize}
	...
	\addproposal{p3852}{https://wg21.link/p3852}
	\addproposal{p3952}{https://wg21.link/p3952}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item \mintinline{cpp}|std::cstring_view| : vue systématiquement \textit{null-terminated}
	\end{itemize}

	\addproposal{p3094}{https://wg21.link/p3094}
	\addproposal{p3283}{https://wg21.link/p3283}
	\addproposal{P3655}{https://wg21.link/P3655}
	\addproposal{P3710}{https://wg21.link/P3710}
	\addproposal{p3862}{https://wg21.link/p3862}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2527}{https://wg21.link/p2527}
	\addproposal{p2141}{https://wg21.link/p2141}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3413}{https://wg21.link/p3413}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item Ajout de \mintinline{cpp}|has_error()|
	\end{itemize}

	\addproposal{p3798}{https://wg21.link/p3798}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3497}{https://wg21.link/p3497}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2727}{https://wg21.link/p2727}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2848}{https://wg21.link/P2848}
	\addproposal{p1708}{https://wg21.link/p1708}
	\addproposal{p2681}{https://wg21.link/p2681}
	\addproposal{p3689}{https://wg21.link/p3689}
	\addproposal{p3104}{https://wg21.link/p3104}
	\addproposal{p3103}{https://wg21.link/p3103}
	\addproposal{p3133}{https://wg21.link/p3133}
	\addproposal{p3516}{https://wg21.link/p3516}
\end{frame}
...
\note[item]{Support de \mintinline{cpp}|char8_t|, \mintinline{cpp}|char16_t| et \mintinline{cpp}|char32_t|, fonction \mintinline{cpp}|constexpr|, meilleure gestion typage}
		...
		\item Support des différents types de caractères (\mintinline{cpp}|char8_t|, \mintinline{cpp}|char16_t|, \mintinline{cpp}|char32_t| et \mintinline{cpp}|wchar_t|) par \mintinline{cpp}|std::to_chars()| et \mintinline{cpp}|std::from_chars()|
	...
	\addproposal{p3605}{https://wg21.link/p3605}
	\addproposal{p3642}{https://wg21.link/p3642}
	\addproposal{p3688}{https://wg21.link/p3688}
	\addproposal{p3711}{https://wg21.link/p3711}
	\addproposal{p3735}{https://wg21.link/p3735}
	\addproposal{p3724}{https://wg21.link/p3724}
	\addproposal{p3876}{https://wg21.link/p3876}
\end{frame}

\begin{frame}[fragile]
	\frametitle{Algorithmes}
	\begin{itemize}
		\item Suppression de la contrainte de régularité sur les prédicats de \mintinline{cpp}|std::find_if()|, \mintinline{cpp}|std::remove_if()|, \mintinline{cpp}|std::all_of()|, \mintinline{cpp}|std::any_of()|, \ldots
...
\note[item]{Le prédicat n'est plus tenu de fournir toujours le même résultat pour un élément donné, car chaque élément n'est parcouru qu'une fois}
		...
		\item Gestion du mode d'arrondi sur les calculs avec des \mintinline{cpp}|float|
		\item Ajout des fonctions de manipulation de \mintinline{cpp}|float| et \mintinline{cpp}|double| de C23 (\mintinline{cpp}|std::iscanonical()|, \mintinline{cpp}|std::iszero()|, \mintinline{cpp}|std::fadd()|, \ldots)
	\end{itemize}

	\addproposal{p3734}{https://wg21.link/p3734}
	\addproposal{p3793}{https://wg21.link/p3793}
	\addproposal{p3764}{https://wg21.link/p3764}
	\addproposal{p3864}{https://wg21.link/p3864}
	\addproposal{p3935}{https://wg21.link/p3935}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2769}{https://wg21.link/p2769}
	\addproposal{p1255}{https://wg21.link/p1255}
	\addproposal{p3544}{https://wg21.link/p3544}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item \mintinline{cpp}|ranges::any_view| : vue type-erasure
		...
		\begin{itemize}
			\item \mintinline{cpp}|reduce()|, \mintinline{cpp}|transform_reduce()|
			\item \mintinline{cpp}|inclusive_scan()|, \mintinline{cpp}|transform_inclusive_scan()|
			\item \mintinline{cpp}|exclusive_scan()|, \mintinline{cpp}|transform_exclusive_scan()|
		\end{itemize}
...
\note[item]{Ces trois fonctions sont des spécialisations \mintinline{cpp}|range::reduce()| et \mintinline{cpp}|range::transform_reduce()| pour l'addition et la multiplication}
		...
		\item \mintinline{cpp}|views::cycle()| répète un range
	\end{itemize}

	\addproposal{p3351}{https://wg21.link/p3351}
	\addproposal{p3411}{https://wg21.link/p3411}
	\addproposal{p3216}{https://wg21.link/p3216}
	\addproposal{p3705}{https://wg21.link/p3705}
	\addproposal{p3732}{https://wg21.link/p3732}
	\addproposal{p3806}{https://wg21.link/p3806}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item \mintinline{cpp}|static_sized_range| : raffinement de \mintinline{cpp}|sized_range| lorsque la taille est connu au \textit{compile-time}
	\end{itemize}

	\addproposal{p3741}{https://wg21.link/p3741}
	\addproposal{p3928}{https://wg21.link/p3928}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item \mintinline{cpp}|std::is_vector_bool_reference<T>|
	\end{itemize}

	\addproposal{p0870}{https://wg21.link/p0870}
	\addproposal{p2782}{https://wg21.link/p2782}
	\addproposal{P2509}{https://wg21.link/P2509}
	\addproposal{p3707}{https://wg21.link/p3707}
	\addproposal{p3780}{https://wg21.link/p3780}
	\addproposal{p3719}{https://wg21.link/p3719}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Capture effectuée dans l'ordre des déclarations
		\item Lambda avec capture assignable par copie ou déplacement si les entités capturées sont assignables
	\end{itemize}

	\addproposal{p3847}{https://wg21.link/p3847}
	\addproposal{p3963}{https://wg21.link/p3963}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item \mintinline{cpp}|std::constructor<T>()| convertit un ensemble de constructeurs en function object
	\end{itemize}

	\addproposal{p2828}{https://wg21.link/p2828}
	\addproposal{p2986}{https://wg21.link/p2986}
	\addproposal{p2966}{https://wg21.link/p2966}
	\addproposal{p3841}{https://wg21.link/p3841}
\end{frame}
...
\note[item]{P.ex. sur \mintinline{cpp}|free|}
	...
	\addproposal{p2992}{https://wg21.link/p2992}
	\addproposal{p2966}{https://wg21.link/p2966}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2994}{https://wg21.link/p2994}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \mintinline{cpp}|std::error_code| et \mintinline{cpp}|std::error_category|
		\end{itemize}
		\item \mintinline{cpp}|std::format_as()| : formateurs personnalisés basé sur un autre type (p.ex. formatage d'enum comme entiers)
	\end{itemize}

	\addproposal{p2945}{https://wg21.link/p2945}
	\addproposal{p3015}{https://wg21.link/p3015}
	\addproposal{p2930}{https://wg21.link/p2930}
	\addproposal{p3258}{https://wg21.link/p3258}
	\addproposal{p3070}{https://wg21.link/p3070}
	\addproposal{p3885}{https://wg21.link/p3885}
\end{frame}

\begin{frame}[fragile]
	\frametitle{\mintinline[style=white]{cpp}|std::format|}
	\begin{itemize}
		\item String interpolation : donnée à formater dans la chaîne de format
	\end{itemize}
	...
	\addproposal{p3951}{https://wg21.link/p3951}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3382}{https://wg21.link/p3382}
\end{frame}
...
\note[item]{Utile pour la création de méta-fonctions template \textit{high-order}, pour avoir des \mintinline{cpp}|static_assert(false)| dépendants et pour certains tests sur les types}
	...
	\addproposal{p2989}{https://wg21.link/p2989}
	\addproposal{p3747}{https://wg21.link/p3747}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3003}{https://wg21.link/p3003}
	\addproposal{p3701}{https://wg21.link/p3701}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3625}{https://wg21.link/p3625}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Retour d'un \mintinline{cpp}|std::string| par \mintinline{cpp}|identifier_of()|
	\end{itemize}

	\addproposal{p3947}{https://wg21.link/p3947}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2839}{https://wg21.link/p2839}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p0901}{https://wg21.link/p0901}
	\addproposal{p3234}{https://wg21.link/p3234}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2966}{https://wg21.link/p2966}
	\addproposal{p3135}{https://wg21.link/p3135}
	\addproposal{p3139}{https://wg21.link/p3139}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2771}{https://wg21.link/p2771}
	\addproposal{p2966}{https://wg21.link/p2966}
	\addproposal{P3810}{https://wg21.link/p3810}
\end{frame}
...
\note[item]{Pour ne pas devoir déclaré \mintinline{cpp}|mutable| tous les mutex. Déjà le cas dans d'autres langages, p.ex. Rust}
		...
		\item \mintinline{cpp}|std::try_lock_until()| et \mintinline{cpp}|std::try_lock_for()|
		\item \mintinline{cpp}|std::multi_lock| wrapper RAII gérant plusieurs mutex (comme \mintinline{cpp}|std::scoped_lock|) et proposant toutes les fonctionnalités de \mintinline{cpp}|std::unique_lock| (verrouillage différé, \textit{try lock}, \ldots)
	\end{itemize}

	\addproposal{p2689}{https://wg21.link/p2689}
	\addproposal{p0876}{https://wg21.link/p0876}
	\addproposal{p2019}{https://wg21.link/p2019}
	\addproposal{p3022}{https://wg21.link/p3022}
	\addproposal{p2966}{https://wg21.link/p2966}
	\addproposal{p3703}{https://wg21.link/p3703}
	\addproposal{p3832}{https://wg21.link/p3832}
	\addproposal{P3833}{https://wg21.link/p3833}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2978}{https://wg21.link/p2978}
	\addproposal{p3686}{https://wg21.link/p3686}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2978}{https://wg21.link/p2978}
	\addproposal{p2966}{https://wg21.link/p2966}
	\addproposal{p3540}{https://wg21.link/p3540}
	\addproposal{p3731}{https://wg21.link/p3731}
\end{frame}
\end{document}