...
\begin{frame}[fragile]
	...
	\begin{block}{Nom}
		\begin{itemize}
			\item Appelé déstructuration (\textit{destructuring}) dans d'autres langages
		\end{itemize}
	\end{block}
...
\begin{frame}[fragile]
	...
	\begin{block}{Note}
		\begin{itemize}
			\item Équivalent non \og \textit{timed}\fg{} de \lstinline|std::shared_timed_mutex|
		\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{alertblock}{Attention}
		\begin{itemize}
			\item \lstinline|operator*()| ou \lstinline|operator->()| sur un \lstinline|std::optional| vide est indéfini
		\end{itemize}
	\end{alertblock}
