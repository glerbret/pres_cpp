...
\note[item]{Dans la continuité de \lstinline|_t| du C++14}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item \lstinline|std::basic_string_view| : vue sur une séquence contiguë de caractères
		\item Quatre spécialisations standard (une pour chaque type de caractères)
...
\note[item]{Une chaîne C : un char* null-terminé}
