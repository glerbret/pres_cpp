...
\begin{frame}[fragile]
	...
	\prop{P0061}{https://wg21.link/P0061R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0386}{https://wg21.link/P0386R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N4230}{https://wg21.link/N4230}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3928}{https://wg21.link/N3928}
\end{frame}
...
\note[item]{C'est à dire qu'en cas de condition composée (\mintinline{cpp}|or|, \mintinline{cpp}|and|), même si la première partie permet de résoudre la condition, il faut que le reste soit évaluable en \textit{compile-time}}
	...
	\prop{P0292}{https://wg21.link/P0292R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0305}{https://wg21.link/P0305R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0217}{https://wg21.link/P0217R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0145}{https://wg21.link/P0145R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0135}{https://wg21.link/P0135R1}
\end{frame}
...
\note[item]{Si tous les éléments sont du même type. C'est une erreur sinon}
	...
	\prop{N3922}{https://wg21.link/N3922}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0138}{https://wg21.link/P0138R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0298}{https://wg21.link/P0298R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0083}{https://wg21.link/P0083R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0084}{https://wg21.link/P0084R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0025}{https://wg21.link/P0025R1}
\end{frame}
...
\note[item]{C'est à dire sur le caractères suivant le dernier écrit pour \mintinline{cpp}|to_chars| ou le premier non converti pour \mintinline{cpp}|from_chars()|}
	...
	\prop{P0067}{https://wg21.link/P0067R5}
\end{frame}
...
\note[item]{Si \mintinline{cpp}|std::monostate| est le premier élément du \mintinline{cpp}|std::variant|, celui-ci devient \textit{default-constructible}}
	...
	\prop{P0088}{https://wg21.link/P0088R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0195}{https://wg21.link/P0195R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0036}{https://wg21.link/P0036R0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0184}{https://wg21.link/P0184R0}
\end{frame}
...
\note[item]{En C++17, \mintinline{cpp}|Baz|  hérite d'un constructeur avec deux paramètres \mintinline{cpp}|int| dont un avec une valeur par défaut qu'il redéfini}
	...
	\prop{P0136}{https://wg21.link/P0136R1}
\end{frame}
...
\note[item]{Une surcharge sans \mintinline{cpp}|noexcept| doit être ajoutée}
	...
	\prop{P0012}{https://wg21.link/P0012R1}
\end{frame}
...
\note[item]{P.ex. rollback}
	...
	\prop{N4259}{https://wg21.link/N4259}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N4267}{https://wg21.link/N4267}
\end{frame}
...
\note[item]{Fonctionne avec \mintinline{cpp}|pair p()|, \mintinline{cpp}|pair p\{\}| et \mintinline{cpp}|pair()| mais pas, pour l'instant, avec \mintinline{cpp}|pair\{\}|}
	...
	\prop{P0091}{https://wg21.link/P0091R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0127}{https://wg21.link/P0127R2}
\end{frame}
...
\note[item]{Jusqu'à présent, on ne pouvait pas capturer la classe courante, seulement des attributs de celle-ci}
	...
	\prop{P0018}{https://wg21.link/P0018R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0170}{https://wg21.link/P0170R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0006}{https://wg21.link/P0006R0}
\end{frame}
...
\note[item]{Surtout utile en méta-programmation via \mintinline{cpp}|enable_if| et le SFINAE}
	...
	\proptwo{P0185}{https://wg21.link/P0185R1}
		{P0013}{https://wg21.link/P0013R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N4266}{https://wg21.link/N4266}
\end{frame}
...
\note[item]{Maintenant, il ne le peut plus et doit seulement ignorer l'attribut (éventuellement avec un avertissement)}
	...
	\proptwo{P0283}{https://wg21.link/P0283R2}
		{P0028}{https://wg21.link/P0028R4}
\end{frame}
...
\note[item]{Généralement pas d'avertissement sur des case vides (cas 1-2 ici)}
	...
	\prop{P0188}{https://wg21.link/P0188R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0189}{https://wg21.link/P0189R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0212}{https://wg21.link/P0212R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N4508}{https://wg21.link/N4508}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0156}{https://wg21.link/P0156R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0220}{https://wg21.link/P0220R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{N3921}{https://wg21.link/N3921}
		{P0220}{https://wg21.link/P0220R1}
\end{frame}
...
\note[item]{Gestion de l'alignement des \textit{Over-Aligned Data}}
	...
	\proptwo{P0414}{https://wg21.link/P0414R2}
		{P0035}{https://wg21.link/P0035R4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0295}{https://wg21.link/P0295R0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0218}{https://wg21.link/P0218R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0024}{https://wg21.link/P0024R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0226}{https://wg21.link/P0226R1}
\end{frame}
\end{document}