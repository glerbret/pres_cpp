...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Dernier Working Draft : \href{https://wg21.link/std17}{N4659\linklogo}
	\end{itemize}
...
\begin{frame}[fragile]
	...
	\addproposal{P0061}{https://wg21.link/P0061}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0386}{https://wg21.link/P0386}
\end{frame}
...
\note[item]{C'est à dire qu'en cas de condition composée (\mintinline{cpp}|or|, \mintinline{cpp}|and|), même si la première partie permet de résoudre la condition, il faut que le reste soit évaluable en \textit{compile-time}}
	...
	\addproposal{P0292}{https://wg21.link/P0292}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0305}{https://wg21.link/P0305}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0217}{https://wg21.link/P0217}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0145}{https://wg21.link/P0145}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0135}{https://wg21.link/P0135}
\end{frame}
...
\note[item]{Pour résumer, C++14 a levé l'interdiction de membres initialisés par défaut, et C++17 assoupli celle sur \og pas d'héritage\fg{}}
	...
	\addproposal{p0017}{https://wg21.link/p0017}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0138}{https://wg21.link/P0138}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0298}{https://wg21.link/P0298}
\end{frame}
