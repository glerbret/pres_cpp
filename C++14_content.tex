...
auto foo = "abcd"s;   // string\end{lstlisting}
	...
	\begin{block}{Note}
		Remplace avantageusement \lstinline|std::string("abcd")| dans de nombreux contextes (p.ex. assertions cppunit)
	\end{block}
\end{frame}
...
cout << get<int>(foo);     // 42\end{lstlisting}
...
cout << PI<const char*>;  // pi\end{lstlisting}
