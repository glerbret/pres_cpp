...
\begin{frame}[fragile]
	...
	\prop{N3652}{https://wg21.link/N3652}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3638}{https://wg21.link/N3638}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3653}{https://wg21.link/N3653}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3644}{https://wg21.link/N3644}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3657}{https://wg21.link/N3657}
\end{frame}
...
\note[item]{Remplacé par \mintinline{cpp}|std::shuffle()| qui permet un meilleur aléa}
	...
	\proptwo{N3668}{https://wg21.link/N3668}
...
\note[item]{Exemple issue de cppreference.com}
	...
	\prop{N3654}{https://wg21.link/N3654}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3472}{https://wg21.link/N3472}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3781}{https://wg21.link/N3781}
\end{frame}
...
\note[item]{Ou \mintinline{cpp}|using namespace std::string_literals| ou \mintinline{cpp}|using namespace std::literals::string_literals|}
	...
	\prop{N3642}{https://wg21.link/N3642}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3670}{https://wg21.link/N3670}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3651}{https://wg21.link/N3651}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3649}{https://wg21.link/N3649}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3648}{https://wg21.link/N3648}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3656}{https://wg21.link/N3656}
\end{frame}
...
\note[item]{Possible car il n'y a pas d'obligation dans la norme. En pratique c'est le cas}
	...
	\prop{N3760}{https://wg21.link/N3760}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N3659}{https://wg21.link/N3659}
\end{frame}
