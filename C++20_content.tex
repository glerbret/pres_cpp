...
\note[item]{Par formatage \og à la C\fg{} j'entends ce qui est utilisé par \lstinline|printf| et équivalent}
				...
				\item Les flux sont complexes, peu propices à l'internationalisation et la localisation, les formateurs sont globaux
...
\note[item]{Le \og formateur\fg{} indique uniquement la base, pas le type précis de la valeur comme en C (\lstinline|int|, \lstinline|short|, \lstinline|long|, \lstinline|long long|) avec toutes les erreurs que cela entraîne}
