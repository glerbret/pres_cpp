...
\note[item]{Ainsi en testant la valeur, on peut savoir l'état d'implémentation de la fonctionnalité si celle-ci a évolué}
	...
	\prop{P0941}{https://wg21.link/P0941R2}
\end{frame}
...
\note[item]{De même le format de la chaîne contenant la fonction n'est pas définie}
	...
	\proptwo{P0754}{https://wg21.link/P0754R2}
...
\begin{frame}[fragile]
	...
	\prop{P0892}{https://wg21.link/P0892R2}
\end{frame}
...
\note[item]{C'est l'unique valeur de la destination congruent à la source modulo $2^N$ où $N$ est le nombre de bits de la destination}
	...
	\prop{P1236}{https://wg21.link/P1236R1}
\end{frame}
...
\note[item]{Pour rappel, le type \mintinline{cpp}|char| est signé ou non en fonction de l'implémentation}
	...
	\proptwo{P0482}{https://wg21.link/P0482R6}
...
\note[item]{Y compris dans les classes de base}
	...
	\prop{P1008}{https://wg21.link/P1008R1}
\end{frame}
...
\note[item]{Par contre, il est permis de ne pas initialiser des champs d'un agrégat}
	...
	\prop{P0329}{https://wg21.link/P0329R4}
\end{frame}
...
\note[item]{Avant C++20, il fallait définir un constructeur}
	...
	\prop{P0960}{https://wg21.link/P0960R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0463}{https://wg21.link/P0463R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1099}{https://wg21.link/P1099R5}
\end{frame}
...
\note[item]{Casse du code, mais simple à corriger et plus cohérent}
	...
	\prop{P1957}{https://wg21.link/P1957R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1286}{https://wg21.link/P1286R2}
\end{frame}
...
\note[item]{Il y a plusieurs autres cas}
	...
	\prop{P1825}{https://wg21.link/P1825R0}
\end{frame}
...
\note[item]{La génération implicite n'a donc lieu que s'il n'y a pas de version explicite}
	...
	\propthree{P1185}{https://wg21.link/P1185R2}
...
\begin{frame}[fragile]
	...
	\prop{P1094}{https://wg21.link/P1094R2}
\end{frame}
...
\note[item]{Mais peut être importée via \mintinline{cpp}|import|}
	...
	\prop{P1103}{https://wg21.link/P1103R3}
\end{frame}
...
\note[item]{La capacité est alors supérieure ou égale à la taille}
	...
	\prop{P0966}{https://wg21.link/P0966R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0457}{https://wg21.link/P0457R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0458}{https://wg21.link/P0458R2}
\end{frame}
...
\note[item]{C'est à dire un foncteur exposant le tag \mintinline{cpp}|is_transparent|}
	...
	\proptwo{P0919}{https://wg21.link/P0919R3}
...
\begin{frame}[fragile]
	...
	\prop{P0646}{https://wg21.link/P0646R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0325}{https://wg21.link/P0325R4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P1209}{https://wg21.link/P1209R0}
		{P1115}{https://wg21.link/P1115R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propthree{P0122}{https://wg21.link/P0122R7}
...
\begin{frame}[fragile]
	...
	\prop{P0769}{https://wg21.link/P0769R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P0556}{https://wg21.link/P0556R3}
		{P1956}{https://wg21.link/P1956R1}
\end{frame}
...
\note[item ]{Respectivement vers la gauche et la droite}
	...
	\prop{P0553}{https://wg21.link/P0553R4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0476}{https://wg21.link/P0476R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0586}{https://wg21.link/P0586R2}
\end{frame}
...
\note[item]{$\gamma$ est la constante de Euler-Mascheroni et $\varphi$ le nombre d'or}
	...
	\proptwo{P0631}{https://wg21.link/P0631R8}
		{P0811}{https://wg21.link/P0811R3}
\end{frame}
...
\frametitle{Mathématiques}
	...
	\prop{P0811}{https://wg21.link/P0811R3}
\end{frame}
...
\note[item]{\textit{Iterators Must Go} est l'article fondateur des \textit{ranges}}
	...
	\proptwo{P0896}{https://wg21.link/P0896R4}
...
\note[item]{Exemple issue de la norme}
	...
	\prop{P0053}{https://wg21.link/P0053R7}
\end{frame}
...
\note[item]{Par défaut, la locale n'est pas prise en compte, mais peut l'être si souhaité}
	...
	\prop{P0645}{https://wg21.link/P0645R10}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P0674}{https://wg21.link/P0674R1}
...
\begin{frame}[fragile]
	...
	\prop{P0722}{https://wg21.link/P0722R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0355}{https://wg21.link/P0355R7}
\end{frame}
...
\note[item]{Auparavant la fonction membre était utilisé bien qu'incohérente}
	...
	\proptwo{P0614}{https://wg21.link/P0614R1}
		{P0962}{https://wg21.link/P0962R1}
\end{frame}
...
\note[item]{\mintinline{cpp}|constexpr| permet une évaluation \textit{compile-time} mais ne l'impose pas}
	...
	\prop{P1073}{https://wg21.link/P1073R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1143}{https://wg21.link/P1143R2}
\end{frame}
...
\note[item]{Par exemple, on peut avoir une branche C++ pour le \textit{compile-time} et une branche assembleur pour le \textit{run-time} avec un choix via \mintinline{cpp}|std::is_constant_evaluated()|}
	...
	\propfour{P1064}{https://wg21.link/P1064R0}
...
\note[item]{En C++17, les lambdas ne peuvent pas capturer de \textit{structured binding}}
	...
	\propthree{P0961}{https://wg21.link/P0961R1}
		{P1091}{https://wg21.link/P1091R3}
		{P1381}{https://wg21.link/P1381R1}
\end{frame}
...
\note[item]{Exemple invalide en C++17 à cause du \mintinline{cpp}|get()| de \mintinline{cpp}|shared_ptr| qui n'était pas utilisable mais empêchait de rechercher dans le \mintinline{cpp}|namespace| englobant. En C++20 cette fonction n'est pas retenue et on recherche dans le \mintinline{cpp}|namespace|}
	...
	\prop{P0969}{https://wg21.link/P0969R0}
\end{frame}
...
\note[item]{En C++17, il faut utiliser un ensemble de \mintinline{cpp}|char| : \mintinline{cpp}|template<char... Id>|}
	...
	\prop{P0732}{https://wg21.link/P0732R2}
\end{frame}
...
\note[item]{Il ne sert qu'à lever des ambigüités}
	...
	\proptwo{P0846}{https://wg21.link/P0846R0}
		{P0887}{https://wg21.link/P0887R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1814}{https://wg21.link/P1814R0}
\end{frame}
...
\note[item]{Exemple de \textit{concept map} : Utilisation de type définissant l'inégalité stricte et la comparaison vers un concept attendant l'inégalité large, implémentation du concept de pile (\textit{stack}) par \mintinline{cpp}|std::vector|}
	...
	\proptwo{P0734}{https://wg21.link/P0734R0}
		{P0898}{https://wg21.link/P0898R3}
\end{frame}
...
\note[item]{Pour indiquer la motivation du marquage \mintinline{cpp}|[[ nodiscard ]]| ou l'erreur potentielle que cache la non-vérification du retour}
	...
	\propfour{P0479}{https://wg21.link/P0479R5}
		{P0840}{https://wg21.link/P0840R2}
		{P1771}{https://wg21.link/P1771R1}
		{P1301}{https://wg21.link/P1301R4}
\end{frame}
...
\note[item]{Les deux syntaxes peuvent cohabiter}
	...
	\proptwo{P0315}{https://wg21.link/P0315R4}
		{P0428}{https://wg21.link/P0428R2}
\end{frame}
...
\note[item]{\mintinline{cpp}|this| est capturé par référence}
	...
	\proptwo{P0624}{https://wg21.link/P0624R2}
...
\begin{frame}[fragile]
	...
	\prop{P0780}{https://wg21.link/P0780R2}
\end{frame}
...
\note[item]{Exemple de types incomplets : \textit{forward declaration} ou types abstraits}
	...
	\proptwo{P0356}{https://wg21.link/P0356R5}
		{P0357}{https://wg21.link/P0357R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propfour{P0718}{https://wg21.link/P0718R2}
...
\note[item]{Il faut rajouter un appel à \mintinline{cpp}|join()| pour corriger ce problème}
	...
	\prop{P0660}{https://wg21.link/P0660R10}
\end{frame}
...
\note[item]{Décrémente le compteur de 1 s'il n'est pas nul et retourne \mintinline{cpp}|true| dans ce cas, et \mintinline{cpp}|false| si le compteur est nul}
	...
	\prop{P1135}{https://wg21.link/P1135R6}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1001}{https://wg21.link/P1001R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0912}{https://wg21.link/P0912R5}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1164}{https://wg21.link/P1164R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0608}{https://wg21.link/P0608R3}
\end{frame}
