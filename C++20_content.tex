...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Dernier Working Draft : \href{https://wg21.link/std20}{N4860\linklogo}
	\end{itemize}
\end{frame}
...
\note[item]{Ainsi en testant la valeur, on peut savoir l'état d'implémentation de la fonctionnalité si celle-ci a évolué}
	...
	\addproposal{P0941}{https://wg21.link/P0941}
\end{frame}
...
\note[item]{Il est toutefois encouragé de numéroter à partir de 1 et de retourner 0 lorsque le numéro n'est pas connu}
	...
	\addproposal{P0754}{https://wg21.link/P0754}
	\addproposal{P1208}{https://wg21.link/P1208}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0892}{https://wg21.link/P0892}
\end{frame}
...
\note[item]{C'est l'unique valeur de la destination congruent à la source modulo $2^N$ où $N$ est le nombre de bits de la destination}
	...
	\addproposal{P1236}{https://wg21.link/P1236}
\end{frame}
...
\note[item]{Et les \textit{Universal character name} doivent correspondre à des \textit{code points} ISO/IEC 10646}
	...
	\addproposal{P0482}{https://wg21.link/P0482}
	\addproposal{P1041}{https://wg21.link/P1041}
\end{frame}
...
\note[item]{Y compris dans les classes de base}
	...
	\addproposal{P1008}{https://wg21.link/P1008}
\end{frame}
...
\note[item]{Par contre, il est permis de ne pas initialiser des champs d'un agrégat}
	...
	\addproposal{P0329}{https://wg21.link/P0329}
\end{frame}
...
\note[item]{Avant C++20, il fallait définir un constructeur}
	...
	\addproposal{P0960}{https://wg21.link/P0960}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0463}{https://wg21.link/P0463}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1099}{https://wg21.link/P1099}
\end{frame}
...
\note[item]{Et donc interdite dans tous les contextes où les conversion \textit{narrowing} ne sont pas autorisées}
	...
	\addproposal{P1957}{https://wg21.link/P1957}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1286}{https://wg21.link/P1286}
\end{frame}
...
\note[item]{Tous ces exemples sont des cas où il y a une copie en C++17 et un déplacement possible en C++20}
	...
	\addproposal{P1825}{https://wg21.link/P1825}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1185}{https://wg21.link/P1185}
	\addproposal{P1186}{https://wg21.link/P1186}
	\addproposal{P0768}{https://wg21.link/P0768}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1094}{https://wg21.link/P1094}
\end{frame}
