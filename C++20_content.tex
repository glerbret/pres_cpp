...
\note[item]{Appelé \textit{counted range}, range représenté par un itérateur de début et un nombre d'éléments}
		...
		\begin{itemize}
			\item \mintinline{cpp}|range| \og{}paresseux\fg{} ne possédant pas les éléments pointés par \mintinline{cpp}|begin()| et \mintinline{cpp}|end()|
...
\note[item]{Les adapteurs \mintinline{cpp}|XXX_view| ont des \textit{closure object} de la forme \mintinline{cpp}|views::XXX|}
	...
	\begin{itemize}
		\item [] \begin{itemize}
			\item \mintinline{cpp}|std::views::transform| : les éléments transformés par l'application d'une fonction
		\end{itemize}
	\end{itemize}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item [] \begin{itemize}
			\item \mintinline{cpp}|std::views::istream| : vue par application successive de \mintinline{cpp}|operator>>| sur un flux
			\item \mintinline{cpp}|std::views::join| joint les éléments d'un \mintinline{cpp}|range|
		\end{itemize}
	\end{itemize}
	...
	\begin{itemize}
		\item  [] \begin{itemize}
			\item \mintinline{cpp}|std::views::split| et \mintinline{cpp}|std::views::lazy_split| séparent un \mintinline{cpp}|range| en élément sur un délimiteur donné
		\end{itemize}
	\end{itemize}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item [] \begin{itemize}
			\item \mintinline{cpp}|std::views::elements| : vue des $N\textsuperscript{e}$ éléments d'une vue de \textit{tuple-likes}
		\end{itemize}
	\end{itemize}
	...
	\begin{itemize}
		\item [] \begin{itemize}
			\item \mintinline{cpp}|std::views::keys| : vue des clés d'une vue de \mintinline{cpp}|std::pair|
		\end{itemize}
	\end{itemize}
	...
	\begin{itemize}
		\item [] \begin{itemize}
			\item \mintinline{cpp}|std::views::values| : vue des valeurs d'une vue de \mintinline{cpp}|std::pair|
		\end{itemize}
	\end{itemize}
