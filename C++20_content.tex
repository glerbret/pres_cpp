...
\note[item]{Par exemple, on peut avoir une branche C++ pour le \textit{compile-time} et une branche asm pour le \textit{run-time} avec un choix via \lstinline|std::is_constant_evaluated()|}
