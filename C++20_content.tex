...
\begin{frame}[fragile]
	\frametitle{\lstinline|std::format| - Nombres entiers}
	\begin{itemize}
...
\begin{frame}[fragile]
	\frametitle{\lstinline|std::format| - Nombres flottants}
	\begin{itemize}
		\item Gestion de l'arrondit
...
\begin{lstlisting}[language=C++]
	format("{:E}", 1.5); 			// "1.500000E+00"\end{lstlisting}

		 \item Affichage en héxadécimal

\begin{lstlisting}[language=C++]
	format("{:a}", 1.5); 			// " 0x1.8p+0"
	format("{:A}", 1.3); 			// "0X1.4CCCCCCCCCCCDP+0"\end{lstlisting}
	\end{itemize}
\end{frame}
...
\begin{frame}[fragile]
	\frametitle{\lstinline|std::format| - Redirection de flux}
	\begin{itemize}
		\item Redirection vers un \lstinline|std::ostream|
		\begin{lstlisting}[language=C++]
print(cerr, "Erreur systeme {}\n", 7);

ofstream error_file("log.txt");
print(error_file, "Erreur systeme {}\n", 7);\end{lstlisting}
	\end{itemize}
\end{frame}
