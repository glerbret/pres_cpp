...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Pilotage par les dates et plus les fonctionnalités
...
\note[item]{Complément à 2 : inversion de chaque bit (complément à 1) puis ajout de 1}
		...
		\begin{itemize}
			\item Doivent pouvoir être reconvertit en \lstinline|void*| avec une valeur égale au pointeur original
			\item Optionnels
		\end{itemize}
	\end{itemize}
\end{frame}
