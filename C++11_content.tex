...
\begin{frame}[fragile]
	...
	\prop{N1811}{https://wg21.link/N1811}
\end{frame}
...
\note[item]{Il est donc impossible de copier une union si un des membres est un type possédant un constructeur de copie défini par l'utilisateur}
	...
	\prop{N2544}{https://wg21.link/N2544}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N2535}{https://wg21.link/N2535}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N2431}{https://wg21.link/N2431}
\end{frame}
...
\note[item]{Et plusieurs autres points dans ce qui suit : opérateurs de conversion explicite, \mintinline{cpp}|enum class|, \mintinline{cpp}|override|, etc.}
	...
	\prop{N1720}{https://wg21.link/N1720}
\end{frame}
...
\note[item]{Et des \textit{null statements}, mais ça n'a pas d'intérêt}
	...
	\prop{N2235}{https://wg21.link/N2235}
\end{frame}
...
\note[item]{Copie désactivée : techniquement compliquée ou dangereux (flux, thread), pas de sens (sémantique d'entité)}
	...
	\propthree{N2118}{https://wg21.link/N2118}
...
\begin{frame}[fragile]
	...
	\prop{N2672}{https://wg21.link/N2672}
\end{frame}
...
\note[item]{Les deux termes se trouvent. Forme simple (par rapport à des langages fonctionnels comme Caml ou Haskell) de l'inférence}
	...
	\prop{N1984}{https://wg21.link/N1984}
\end{frame}
...
\note[item]{Au passage, cette ligne ne compile pas car la référence n'est pas initialisée}
	...
	\proptwo{N2343}{https://wg21.link/N2343}{N3276}{https://wg21.link/N3276}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{N2930}{https://wg21.link/N2930}
...
\note[item]{Pas de garantie en C++98/03, implémentation-defined}
	...
	\prop{N2249}{https://wg21.link/N2249}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N2442}{https://wg21.link/N2442}
\end{frame}
...
\note[item]{L'erreur de compilation peut ici tout simplement être corrigée en utilisant l'initialisation via \{\}, mais c'est pour l'exemple}
	...
	\prop{N2765}{https://wg21.link/N2765}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N2346}{https://wg21.link/N2346}
\end{frame}
...
\note[item]{Y compris pour les valeurs \og par défaut\fg{} modifiées dans seulement une petite partie des constructeurs}
	...
	\prop{N2756}{https://wg21.link/N2756}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N1986}{https://wg21.link/N1986}
\end{frame}
...
\note[item]{Donc initialisation d'attribut si présente, sinon constructeur par défaut (ou non initialisation pour \mintinline{cpp}|int|, pointeur, \ldots{}) et erreur si un membre ne peut pas être construit}
	...
	\prop{N2540}{https://wg21.link/N2540}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propthree{N2928}{https://wg21.link/N2928}
...
\begin{frame}[fragile]
	...
	\prop{N2437}{https://wg21.link/N2437}
\end{frame}
...
\note[item]{En pratique, seule \mintinline{cpp}|throw()| était utilisée et utilisable et a été remplacée par \mintinline{cpp}|noexcept|}
	...
	\prop{N3050}{https://wg21.link/N3050}
\end{frame}
...
\note[item]{Sur les énumérations classiques aussi}
	...
	\prop{N2347}{https://wg21.link/N2347}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propthree{N2550}{https://wg21.link/N2550}
...
\note[item]{En C++98/03, il fallait un espace entre les deux >}
	...
	\prop{N1757}{https://wg21.link/N1757}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N2258}{https://wg21.link/N2258}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N1987}{https://wg21.link/N1987}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{N2242}{https://wg21.link/N2242}
...
\begin{frame}[fragile]
	...
	\begin{minted}{cpp}
 	...
 	\prop{N2657}{https://wg21.link/N2657}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N2761}{https://wg21.link/N2761}
\end{frame}
...
\note[item]{C'est à dire qu'il y a une instance de la variable par thread}
	...
	\prop{N2659}{https://wg21.link/N2659}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N2427}{https://wg21.link/N2427}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{N1429}{https://wg21.link/N1429}
\end{frame}
