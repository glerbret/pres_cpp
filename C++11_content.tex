...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Dernier \textit{Working Draft} : \href{https://wg21.link/std11}{N3337\linklogo}
		...
		\end{itemize}
		\item Objectifs : sûreté, simplicité, rapidité et meilleure détection d'erreur en \textit{compile-time}
	\end{itemize}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{N4193}{https:wg21.link/n4193}
\end{frame}
...
\note[item]{En gros les motivations sont : peu utile, peu demandé, compliqué à implémenter et compliqué à utiliser}
	...
	\addproposal{N1426}{https://wg21.link/N1426}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{N1811}{https://wg21.link/N1811}
	\addproposal{N1835}{https://wg21.link/n1835}
	\addproposal{n1988}{https://wg21.link/n1988}
\end{frame}
...
\note[item]{Les constructeurs déclarés \mintinline{cpp}|=default| par l'utilisateur sont autorisés}
	...
	\addproposal{n2342}{https://wg21.link/n2342}
\end{frame}
...
\note[item]{Il est donc impossible de copier une union si un des membres est un type possédant un constructeur de copie défini par l'utilisateur}
	...
	\addproposal{N2544}{https://wg21.link/N2544}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{N2535}{https://wg21.link/N2535}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{N2431}{https://wg21.link/N2431}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{N1720}{https://wg21.link/N1720}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{block}{\mintinline[style=white]{cpp}|unordered_<XXX>| ?}
		\begin{itemize}
			\item Nombreuses implémentations \mintinline{cpp}|hash_<XXX>| existantes
...
\begin{frame}[fragile]
	...
	\begin{exampleblock}{Do}
		\begin{itemize}
			\item Préférez un \mintinline{cpp}|std::tuple| de retour aux paramètres \og{}\textit{OUT}\fg{}
		\end{itemize}
	\end{exampleblock}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item \mintinline{cpp}|[capture](paramètres) spécificateurs -> type_retour {instructions}|
	\end{itemize}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item \mintinline{cpp}|std::ratio_add()|, \mintinline{cpp}|std::ratio_subtract()|
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item Spécificateur de classe de stockage \mintinline{cpp}|thread_local|
