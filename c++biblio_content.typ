...
#addbook("Effective Modern C++: 42 Specific Ways to Improve Your Use of C++11 and C++14", "Scott Meyers")
...
#addarticle("Changes between C++14 and C++17 DIS", "https://isocpp.org/files/papers/p0636r0.html", "Thomas Köppe")
#addarticle(
...
#addarticle("Pointeurs intelligents", "https://loic-joly.developpez.com/tutoriels/cpp/smart-pointers/", "Loïc Joly")
#addarticle(
  "Iterators Must Go",
...
#addblog("Eric Niebler", "https://ericniebler.com/", "Eric Niebler")
#addblog("Oleksandr Koval's blog", "https://oleksandrkvl.github.io/", "Oleksandr Koval")
