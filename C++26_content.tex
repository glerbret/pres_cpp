...
\begin{frame}[fragile]
	...
	\addproposal{p2875}{https://wg21.link/p2875r4}
	\addproposal{p3247}{https://wg21.link/p3247r2}
	\addproposal{p3475}{https://wg21.link/p3475r1}
	\addproposal{p3176}{https://wg21.link/p3176r1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2867}{https://wg21.link/P2867R2}
	\addproposal{p2868}{https://wg21.link/p2868r3}
	\addproposal{P2869}{https://wg21.link/P2869R4}
	\addproposal{P2870}{https://wg21.link/P2870R3}
	\addproposal{P2871}{https://wg21.link/P2871R3}
	\addproposal{P2872}{https://wg21.link/P2872R3}
	\addproposal{p2865}{https://wg21.link/p2865r6}
	\addproposal{p3682}{https://wg21.link/p3682r0}
\end{frame}
...
\note[item]{Auparavant, undefined behavior}
		...
		\item \mintinline{cpp}|std::observable_checkpoint()| empêche la propagation de supposition basé sur de potentiels comportements indéfinis et la suppression de code basé sur cette supposition
	\end{itemize}
	...
	\addproposal{p3144}{https://wg21.link/p3144r2}
	\addproposal{p1494}{https://wg21.link/p1494r5}
	\addproposal{p3641}{https://wg21.link/p3641r0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2621}{https://wg21.link/P2621R3}
\end{frame}
...
\note[item]{Supportés par tous les encodages communément utilisés}
	...
	\addproposal{p1885}{https://wg21.link/p1885r12}
	\addproposal{p2862}{https://wg21.link/p2862r1}
\end{frame}
...
\note[item]{L'idée est de permettre certaines optimisations sur les objets correspondants}
	...
	\addproposal{P2786}{https://wg21.link/P2786R13}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P3019}{https://wg21.link/P3019R14}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{codesample}
		\sample{https://godbolt.org/#g:!((g:!((g:!((h:codeEditor,i:(filename:'1',fontScale:14,fontUsePx:'0',j:1,lang:c%2B%2B,selection:(endColumn:1,endLineNumber:1,positionColumn:1,positionLineNumber:1,selectionStartColumn:1,selectionStartLineNumber:1,startColumn:1,startLineNumber:1),source:'%23include+%3Ciostream%3E%0A%0Astruct+Foo+%0A%7B%0A++int+a%3B%0A++int+b%3B%0A%0A++explicit+operator+bool+()+const%0A++%7B+%0A++++return+a+!!%3D+b%3B%0A++%7D%0A%7D%3B%0A%0Aint+main()%0A%7B%0A++if(auto+%5Ba,+b%5D+%3D+Foo%7B2,+5%7D)%0A++%7B%0A++++std::cout+%3C%3C+%222+!!%3D+5%5Cn%22%3B%0A++%7D%0A++else%0A++%7B%0A++++std::cout+%3C%3C+%222+%3D%3D+5%5Cn%22%3B%0A++%7D%0A%0A++if(auto+%5Ba,+b%5D+%3D+Foo%7B2,+2%7D)%0A++%7B%0A++++std::cout+%3C%3C+%222+!!%3D+2%5Cn%22%3B%0A++%7D%0A++else%0A++%7B%0A++++std::cout+%3C%3C+%222+%3D%3D+2%5Cn%22%3B%0A++%7D%0A%0A%7D'),l:'5',n:'0',o:'C%2B%2B+source+%231',t:'0')),k:50,l:'4',n:'0',o:'',s:0,t:'0'),(g:!((h:executor,i:(argsPanelShown:'1',compilationPanelShown:'0',compiler:gsnapshot,compilerName:'',compilerOutShown:'0',execArgs:'',execStdin:'',fontScale:14,fontUsePx:'0',j:1,lang:c%2B%2B,libs:!(),options:'-std%3Dc%2B%2B2c+-Wall+-Wextra+-pedantic',overrides:!(),runtimeTools:!(),source:1,stdinPanelShown:'1',tree:'1',wrap:'0'),l:'5',n:'0',o:'Executor+x86-64+gcc+(trunk)+(C%2B%2B,+Editor+%231)',t:'0')),header:(),k:50,l:'4',n:'0',o:'',s:0,t:'0')),l:'2',n:'0',o:'',t:'0')),version:4}
	\end{codesample}
...
\begin{frame}[fragile]
	...
	\addproposal{p1061}{https://wg21.link/p1061r10}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2841}{https://wg21.link/P2841R7}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2927}{https://wg21.link/p2927r3}
\end{frame}
...
\note[item]{Contrairement à \mintinline{cpp}|std::array| la taille n'est pas fixée, seule la capacité l'est, et donc utilisable pour des éléments \og sans valeur par défaut\fg{}}
	...
	\addproposal{p0843}{https://wg21.link/p0843r14}
	\addproposal{P0447}{https://wg21.link/p0447r28}
...
\begin{frame}[fragile]
	...
	\addproposal{P2821}{https://wg21.link/p2821r5}
	\addproposal{p3383}{https://wg21.link/p3383r3}
	\addproposal{p3355}{https://wg21.link/p3355r1}
	\addproposal{P2642}{https://wg21.link/P2642R6}
	\addproposal{p2389}{https://wg21.link/p2389r2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2591}{https://wg21.link/P2591R5}
\end{frame}
...
\note[item]{Évite de copier les données depuis le static storage vers le tableau sous-jacent de l'\textit{initializer list} puis vers le conteneur}
	...
	\addproposal{P2752}{https://wg21.link/P2752R3}
...
\begin{frame}[fragile]
	...
	\addproposal{P2944}{https://wg21.link/P2944R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2988}{https://wg21.link/p2988r12}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1673}{https://wg21.link/P1673R13}
	\addproposal{p3050}{https://wg21.link/p3050r2}
	\addproposal{p3222}{https://wg21.link/p3222r0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2542}{https://wg21.link/P2542R8}
	\addproposal{P1068}{https://wg21.link/P1068R11}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3138}{https://wg21.link/p3138r5}
	\addproposal{p3137}{https://wg21.link/p3137r3}
	\addproposal{p2846}{https://wg21.link/p2846r6}
	\addproposal{p3044}{https://wg21.link/p3044r2}
	\addproposal{p3060}{https://wg21.link/p3060r3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3179}{https://wg21.link/p3179r9}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2686}{https://wg21.link/P2686R5}
	\addproposal{P3309}{https://wg21.link/P3309R3}
	\addproposal{p2747}{https://wg21.link/p2747r2}
	\addproposal{p3372}{https://wg21.link/p3372r3}
	\addproposal{p3533}{https://wg21.link/p3533r2}
	\addproposal{p3037}{https://wg21.link/p3037r6}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P3068}{https://wg21.link/P3068R6}
	\addproposal{P3378}{https://wg21.link/P3378R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p1928}{https://wg21.link/p1928r15}
	\addproposal{P3430}{https://wg21.link/P3430R3}
	\addproposal{P3441}{https://wg21.link/P3441R2}
	\addproposal{P3287}{https://wg21.link/P3287R3}
	\addproposal{P2663}{https://wg21.link/P2663R7}
	\addproposal{P2933}{https://wg21.link/P2933R4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2714}{https://wg21.link/p2714r1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2905}{https://wg21.link/p2905r2}
	\addproposal{P2918}{https://wg21.link/P2918R2}
	\addproposal{P2845}{https://wg21.link/P2845R8}
	\addproposal{p2909}{https://wg21.link/p2909r4}
...
\begin{frame}[fragile]
	...
	\addproposal{p3107}{https://wg21.link/p3107r5}
	\addproposal{p3235}{https://wg21.link/p3235r3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3008}{https://wg21.link/p3008r6}
	\addproposal{p2835}{https://wg21.link/p2835r7}
	\addproposal{p2300}{https://wg21.link/p2300r10}
	\addproposal{p3325}{https://wg21.link/p3325r5}
	\addproposal{p3149}{https://wg21.link/p3149r11}
	\addproposal{p2079}{https://wg21.link/p2079r10}
	\addproposal{p3552}{https://wg21.link/p3552r3}
	\addproposal{p3111}{https://wg21.link/p3111r8}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2075}{https://wg21.link/p2075r6}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2900}{https://wg21.link/P2900R14}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2996}{https://wg21.link/p2996r13}
	\addproposal{p3096}{https://wg21.link/p3096r9}
	\addproposal{p1306}{https://wg21.link/p1306r4}
	\addproposal{p3491}{https://wg21.link/p3491r3}
	\addproposal{p3293}{https://wg21.link/p3293r2}
	\addproposal{p3394}{https://wg21.link/p3394r3}
	\addproposal{p3560}{https://wg21.link/p3560r2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p1967}{https://wg21.link/p1967r14}
\end{frame}
