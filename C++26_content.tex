...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item Annulation de la dépréciation en C++23 de \mintinline{cpp}|std::polymorphic_allocator::destroy|
...
\note[item]{Auparavant, undefined behavior}
		...
		\item \mintinline{cpp}|std::observable()| empêche la propagation de supposition basé sur de potentiels comportements indéfinis et la suppression de code basé sur cette supposition

\note[item]{Proposition pour renommer \mintinline{cpp}|std::observable()| en \mintinline{cpp}|std::observable_checkpoint()|}
	\end{itemize}
	...
	\addproposal{p1494}{https://wg21.link/p1494r4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P3019R}{https://wg21.link/P3019R13}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p3179}{https://wg21.link/p3179r8}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Placement \mintinline{cpp}|new| \mintinline{cpp}|constexpr|
	\end{itemize}
...
\begin{frame}[fragile]
	...
	\addproposal{p3149}{https://wg21.link/p3149r10}
	\addproposal{p2079}{https://wg21.link/p2079r8}
	\addproposal{p3552}{https://wg21.link/p3552r2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2996}{https://wg21.link/p2996r12}
	\addproposal{p3096}{https://wg21.link/p3096r9}
	\addproposal{p1306}{https://wg21.link/p1306r4}
	\addproposal{p3491}{https://wg21.link/p3491r2}
