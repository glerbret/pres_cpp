...
\begin{frame}[fragile]
	\frametitle{Contrats - Présentation}
	\begin{alertblock}{Nombreuses critiques}
		\begin{itemize}
			\item \href{https://wg21.link/p3909}{P3909 : Contracts should go into a White Paper - even at this late point}
			\item \href{https://wg21.link/p3851}{P3851 : Position on contracts assertion for C++26}
			\item \href{https://wg21.link/P4043}{P4043 : Are C++ Contracts Ready to Ship in C++26?}
			\item \href{https://wg21.link/p4020}{P4020 : Concerns about contract assertions}
		\end{itemize}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Sémantique \mintinline{cpp}|assume| sur les contrats non vérifiés

\note[item]{Permettait au compilateur d'optimiser en fonction du contrat}
...
\begin{frame}[fragile]
	\frametitle{Contrats - Préconditions}
	\begin{itemize}
		\item Sur les déclarations de fonctions et coroutines
		\item Introduites par le mot-clé contextuel \mintinline{cpp}|pre|
...
\begin{frame}[fragile]
	\frametitle{Contrats - Postconditions}
	\begin{itemize}
		\item Sur les déclarations de fonctions et coroutines
		\item Introduites par le mot-clé contextuel \mintinline{cpp}|post|
	...
	\begin{block}{Note}
		\begin{itemize}
			\item Seuls les paramètres \mintinline{cpp}|const| ou de type référence sont utilisables
		\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Introduite par le mot-clé \mintinline{cpp}|contract_assert|
	\end{itemize}
...
\begin{frame}[fragile]
	\frametitle{Contrats - Sémantiques}
	\begin{itemize}
...
\note[item]{\mintinline{cpp}|observe| : on laisse le \textit{handler} décider}
		...
		\begin{itemize}
			\item \mintinline{cpp}|observe| : warning
			\item \mintinline{cpp}|enforce| et \mintinline{cpp}|quick_enforce| : erreur
		\end{itemize}
		\item Possibilité de remplacer le \textit{handler} par défaut :
		\begin{itemize}
			\item Fonction \mintinline{cpp}|handle_contract_violation|
			\item Paramètre de type \mintinline{cpp}|std::contracts::contract_violation|
		\end{itemize}
	\end{itemize}
\end{frame}
