...
\begin{frame}[fragile]
	...
	\prop{P2741}{https://wg21.link/P2741R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2621}{https://wg21.link/P2621R2}
\end{frame}
...
\note[item]{Supportés par tous les encodages communément utilisés}
	...
	\proptwo{P2558}{https://wg21.link/P2558R2}
		{P1854}{https://wg21.link/P1854R4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0543}{https://wg21.link/P0543R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2169}{https://wg21.link/P2169R4}
\end{frame}
...
\note[item]{Contrairement à \mintinline{cpp}|std::array| la taille n'est pas fixée, seule la capacité l'est, et donc utilisable pour des éléments \og sans valeur par défaut\fg{}}
	...
	\propthree{p0843}{https://wg21.link/p0843r9}
		{P1901}{https://wg21.link/P1901R2}
		{P2630}{https://wg21.link/P2630R4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P2495}{https://wg21.link/P2495R3}
		{P2697}{https://wg21.link/P2697R1}
\end{frame}
...
\note[item]{Évite de copier les données depuis le static storage vers le tableau sous-jacent de l'\textit{initializer list} puis vers le conteneur}
	...
	\prop{P2752}{https://wg21.link/P2752R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1673}{https://wg21.link/P1673R12}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2637}{https://wg21.link/P2637R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2734}{https://wg21.link/P2734R0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2738}{https://wg21.link/P2738R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2662}{https://wg21.link/P2662R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2641}{https://wg21.link/P2641R4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P2530}{https://wg21.link/P2530R3}
		{P2545}{https://wg21.link/P2545R4}
\end{frame}
...
\note[item]{Les fonctions n'ont pas besoin d'être copiables ni déplaçables}
	...
	\proptwo{P2548}{https://wg21.link/P2548R6}
		{P0792}{https://wg21.link/P0792R14}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propfour{P2918}{https://wg21.link/P2918R2}
		{P2587}{https://wg21.link/P2587R3}
		{P2757}{https://wg21.link/P2757R3}
		{P2510}{https://wg21.link/P2510R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2592}{https://wg21.link/P2592R3}
\end{frame}
...
\note[item]{\mintinline{cpp}|int| sous POSIX, \mintinline{cpp}|HANDLE| (\mintinline{cpp}|void*|) sous Windows}
	...
	\prop{P1759}{https://wg21.link/P1759R6}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2546}{https://wg21.link/P2546R5}
\end{frame}
\end{document}