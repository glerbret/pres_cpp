...
\note[item]{Avant soit une chaîne vide, soit \mintinline{cpp}|"\ "| selon le compilateur}
	...
	\prop{P2223}{https://wg21.link/P2223R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2324}{https://wg21.link/P2324R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2334}{https://wg21.link/P2334R1}
\end{frame}
...
\note[item]{Déjà présent dans la plupart des compilateurs}
	...
	\prop{P2437}{https://wg21.link/P2437R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P2590}{https://wg21.link/P2590R2}
		{P2679}{https://wg21.link/P2679R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1467}{https://wg21.link/P1467R9}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2513}{https://wg21.link/P2513R4}
\end{frame}
...
\note[item]{Déjà le cas sur Visual C++}
	...
	\prop{P2460}{https://wg21.link/P2460R2}
\end{frame}
...
\note[item]{\mintinline{cpp}|auto a = x| construit une \textit{lvalue}, non une \textit{prvalue}}
	...
	\prop{P1401}{https://wg21.link/P1401R5}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1682}{https://wg21.link/P1682R3}
\end{frame}
...
\note[item]{Lorsque la fonction ne peut qu'être invoquée au \textit{compile-time}}
	...
	\propthree{P2242}{https://wg21.link/P2242R3}
		{P2448}{https://wg21.link/P2448R2}
		{P2647}{https://wg21.link/P2647R1}
\end{frame}
...
\note[item]{P.ex. dans une fonction \mintinline{cpp}|constexpr|}
	...
	\prop{P1938}{https://wg21.link/P1938R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P2266}{https://wg21.link/P2266R3}
		{P0288}{https://wg21.link/P0288R9}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2718}{https://wg21.link/P2718R0}
\end{frame}
...
\note[item]{En C++20, il est possible d'utiliser \mintinline{cpp}|typedef| dans l'\textit{init-statement}}
	...
	\prop{P2360}{https://wg21.link/P2360R0}
\end{frame}
...
\note[item]{Et ainsi \mintinline{cpp}|\#if 'A' == '\\x41'| et \mintinline{cpp}|if('A' == 0x41)| donner des résultats différents}
	...
	\proptwo{P2295}{https://wg21.link/P2295R6}
		{P2316}{https://wg21.link/P2316R2}
\end{frame}
...
\note[item]{Correspond à \mintinline{cpp}|ptrdiff_t| ou \mintinline{cpp}|ssize_t|}
	...
	\prop{P0330}{https://wg21.link/P0330R8}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2201}{https://wg21.link/P2201R1}
\end{frame}
...
\note[item]{Délimitées et pas de taille fixe}
	...
	\propfour{P2314}{https://wg21.link/P2314R4}
		{P2362}{https://wg21.link/P2362R3}
		{P2290}{https://wg21.link/P2290R3}
		{P2071}{https://wg21.link/P2071R2}
\end{frame}
...
\note[item]{Ambiguïté provoquée par l'absence de \mintinline{cpp}|const|, l'opérateur défini ne matche pas directement et deux réécritures (via \mintinline{cpp}|operator==| et via \mintinline{cpp}|operator!=|) sont éligibles}
	...
	\prop{P2468}{https://wg21.link/P2468R2}
\end{frame}
...
\note[item]{Auparavant : utilisation de \mintinline{cpp}|operator()|, de chaîne d'appel de \mintinline{cpp}|[]| ou d'une surcharge de \mintinline{cpp}|operator[]| prenant un agrégat \textit{tuple-like}}
	...
	\prop{P2128}{https://wg21.link/P2128R6}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P1169}{https://wg21.link/P1169R4}
		{P2589}{https://wg21.link/P2589R0}
\end{frame}
...
\note[item]{Auparavant, la résolution de nom du retour ne prenait pas en compte les variables capturées}
	...
	\propthree{P1102}{https://wg21.link/P1102R2}
		{P2036}{https://wg21.link/P2036R3}
		{P2173}{https://wg21.link/P2173R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2136}{https://wg21.link/P2136R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2156}{https://wg21.link/P2156R1}
\end{frame}
...
\note[item]{UB dans le cas contraire}
	...
	\prop{P1774}{https://wg21.link/P1774R8}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1847}{https://wg21.link/P1847R4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0847}{https://wg21.link/P0847R7}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2582}{https://wg21.link/P2582R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1048}{https://wg21.link/P1048R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P2674}{https://wg21.link/P2674R1}
		{P2255}{https://wg21.link/P2255R2}
\end{frame}
...
\note[item]{Erreur de compilation, avant c'était un comportement indéfini}
	...
	\propfour{P1679}{https://wg21.link/P1679R3}
		{P2166}{https://wg21.link/P2166R1}
		{P1989}{https://wg21.link/P1989R2}
		{P2251}{https://wg21.link/P2251R1}
\end{frame}
...
\note[item]{En se limitant à la taille allouée bien sûr}
	...
	\prop{P1072}{https://wg21.link/P1072R10}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2251}{https://wg21.link/P2251R1}
\end{frame}
...
\note[item]{Code auparavant valide mais inefficace}
	...
	\proptwo{P1951}{https://wg21.link/P1951R1}
		{P2165}{https://wg21.link/P2165R4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1425}{https://wg21.link/P1425R4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propthree{P2077}{https://wg21.link/P2077R3}
		{P0429}{https://wg21.link/P0429R9}
		{P1222}{https://wg21.link/P1222R4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propfour{P0009}{https://wg21.link/P0009R18}
		{P2599}{https://wg21.link/P2599R2}
		{P2604}{https://wg21.link/P2604R0}
		{P2613}{https://wg21.link/P2613R1}
%		{P2763}{https://wg21.link/P2763R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propfour{P2259}{https://wg21.link/P2259R1}
		{P2278}{https://wg21.link/P2278R4}
		{P2408}{https://wg21.link/P2408R5}
		{P2520}{https://wg21.link/P2520R0}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P1272}{https://wg21.link/P1272R4}
\end{frame}
...
\note[item]{\mintinline{cpp}|strstream| déprécié depuis C++98}
	...
	\proptwo{P0448}{https://wg21.link/P0448R4}
		{P2467}{https://wg21.link/P2467R1}
\end{frame}
...
\note[item]{Par cohérence avec tous les autres données}
	...
	\propthree{P2572}{https://wg21.link/P2572R1}
		{P2419}{https://wg21.link/P2419R2}
		{P2372}{https://wg21.link/P2372R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propthree{P2418}{https://wg21.link/P2418R2}
		{P2286}{https://wg21.link/P2286R8}
		{P2693}{https://wg21.link/P2693R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P2093}{https://wg21.link/P2093R14}
		{P2539}{https://wg21.link/P2539R3}
\end{frame}
...
\note[item]{Pas d'exception dans le code C++ avant le rétablissement du \textit{smart pointer}}
	...
	\prop{P1132}{https://wg21.link/P1132R8}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P0881}{https://wg21.link/P0881R7}
		{P2301}{https://wg21.link/P2301R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0627}{https://wg21.link/P0627R6}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P0943}{https://wg21.link/P0943R6}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2212}{https://wg21.link/P2212R2}
\end{frame}
...
\note[item]{Auparavant, les variants de \mintinline{cpp}|std::visit| pouvaient être formellement de n'importe quel type}
	...
	\prop{P2162}{https://wg21.link/P2162R2}
\end{frame}
...
\note[item]{Peut modifier aussi éventuellement le type}
	...
	\prop{P0798}{https://wg21.link/P0798R8}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P0323}{https://wg21.link/P0323R12}
		{P2549}{https://wg21.link/P2549R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2505}{https://wg21.link/P2505R5}
\end{frame}
...
\note[item]{Maintenant aussi des ranges de \textit{prvalues non view ranges}}
	...
	\proptwo{P1206}{https://wg21.link/P1206R7}
		{P2278}{https://wg21.link/P2278R4}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2210}{https://wg21.link/P2210R2}
\end{frame}
...
\note[item]{Équivalents à leur contreparties \mintinline{cpp}|std|}
	...
	\proptwo{P2440}{https://wg21.link/P2440R1}
		{P2328}{https://wg21.link/P2328R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\propfour{P1223}{https://wg21.link/P1223R5}
		{P2322}{https://wg21.link/P2322R6}
		{P2374}{https://wg21.link/P2374R4}
		{P2540}{https://wg21.link/P2540R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2446}{https://wg21.link/P2446R2}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2017}{https://wg21.link/P2017R1}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2387}{https://wg21.link/P2387R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\prop{P2465}{https://wg21.link/P2465R3}
\end{frame}
...
\begin{frame}[fragile]
	...
	\proptwo{P2502}{https://wg21.link/P2502R2}
		{P2787}{https://wg21.link/P2787R0}
\end{frame}
\end{document}