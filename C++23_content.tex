...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Dernier Working Draft : \href{https://github.com/cplusplus/draft/releases/download/n4868/n4868.pdf}{n4868}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Création d'un Study Group pour la liaison C/C++ (SG22) : aide à l'apprentissage et à l'adoption des évolutions
	\end{itemize}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Récupératoon de la \textit{stacktrace} actuelle
