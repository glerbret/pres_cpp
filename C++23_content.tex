...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Dernier \textit{Working Draft} : \href{https://wg21.link/std23}{n4950\linklogo}
	\end{itemize}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p1413}{https://wg21.link/p1413}
\end{frame}
...
\note[item]{Avant soit une chaîne vide, soit \mintinline{cpp}|"\ "| selon le compilateur}
	...
	\addproposal{P2223}{https://wg21.link/P2223}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2324}{https://wg21.link/P2324}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2334}{https://wg21.link/P2334}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2437}{https://wg21.link/P2437}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2590}{https://wg21.link/P2590}
	\addproposal{P2679}{https://wg21.link/P2679}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1467}{https://wg21.link/P1467}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2513}{https://wg21.link/P2513}
\end{frame}
...
\note[item]{Tous les codes points Unicode (21 bits) ne sont pas représentables sur un \mintinline{cpp}|wchar_t| 16 bits}
	...
	\addproposal{P2460}{https://wg21.link/P2460}
\end{frame}
...
\note[item]{Donc pas de const ni de volatile et les tableaux C deviennent des pointeurs}
	...
	\addproposal{P1401}{https://wg21.link/P1401}
	\addproposal{p0849}{https://wg21.link/p0849}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1682}{https://wg21.link/P1682}
\end{frame}
...
\note[item]{Lorsque la fonction ne peut qu'être invoquée au \textit{compile-time}}
	...
	\addproposal{P2242}{https://wg21.link/P2242}
	\addproposal{P2448}{https://wg21.link/P2448}
	\addproposal{P2647}{https://wg21.link/P2647}
	\addproposal{p2273}{https://wg21.link/p2273}
\end{frame}
...
\note[item]{P.ex. dans une fonction \mintinline{cpp}|constexpr|}
	...
	\addproposal{P1938}{https://wg21.link/P1938}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2266}{https://wg21.link/P2266}
	\addproposal{P0288}{https://wg21.link/P0288}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2718}{https://wg21.link/P2718}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2360}{https://wg21.link/P2360}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2295}{https://wg21.link/P2295}
	\addproposal{P2316}{https://wg21.link/P2316}
\end{frame}
...
\note[item]{Correspond à \mintinline{cpp}|ptrdiff_t| ou \mintinline{cpp}|ssize_t|}
	...
	\addproposal{P0330}{https://wg21.link/P0330}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2201}{https://wg21.link/P2201}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2314}{https://wg21.link/P2314}
	\addproposal{P2362}{https://wg21.link/P2362}
	\addproposal{P2290}{https://wg21.link/P2290}
	\addproposal{P2071}{https://wg21.link/P2071}
\end{frame}
...
\note[item]{Ambiguïté provoquée par l'absence de \mintinline{cpp}|const|, l'opérateur défini ne matche pas directement et deux réécritures (via \mintinline{cpp}|operator==| et via \mintinline{cpp}|operator!=|) sont éligibles}
	...
	\addproposal{P2468}{https://wg21.link/P2468}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2128}{https://wg21.link/P2128}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1169}{https://wg21.link/P1169}
	\addproposal{P2589}{https://wg21.link/P2589}
\end{frame}
...
\note[item]{Auparavant, la résolution de nom du retour ne prenait pas en compte les variables capturées}
	...
	\addproposal{P1102}{https://wg21.link/P1102}
	\addproposal{P2036}{https://wg21.link/P2036}
	\addproposal{P2173}{https://wg21.link/P2173}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2136}{https://wg21.link/P2136}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2156}{https://wg21.link/P2156}
\end{frame}
...
\note[item]{UB dans le cas contraire}
	...
	\addproposal{P1774}{https://wg21.link/P1774}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1847}{https://wg21.link/P1847}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0847}{https://wg21.link/P0847}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2582}{https://wg21.link/P2582}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1048}{https://wg21.link/P1048}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2674}{https://wg21.link/P2674}
	\addproposal{P2255}{https://wg21.link/P2255}
\end{frame}
...
\note[item]{Erreur de compilation, avant c'était un comportement indéfini}
	...
	\addproposal{P1679}{https://wg21.link/P1679}
	\addproposal{P2166}{https://wg21.link/P2166}
	\addproposal{P1989}{https://wg21.link/P1989}
	\addproposal{P2251}{https://wg21.link/P2251}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1072}{https://wg21.link/P1072}
\end{frame}
...
\note[item]{Code auparavant valide mais inefficace}
	...
	\addproposal{P1951}{https://wg21.link/P1951}
	\addproposal{P2165}{https://wg21.link/P2165}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1425}{https://wg21.link/P1425}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2077}{https://wg21.link/P2077}
	\addproposal{P0429}{https://wg21.link/P0429}
	\addproposal{P1222}{https://wg21.link/P1222}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0009}{https://wg21.link/P0009}
	\addproposal{P2599}{https://wg21.link/P2599}
	\addproposal{P2604}{https://wg21.link/P2604}
	\addproposal{P2613}{https://wg21.link/P2613}
...
\begin{frame}[fragile]
	...
	\addproposal{P2259}{https://wg21.link/P2259}
	\addproposal{P2278}{https://wg21.link/P2278}
	\addproposal{P2408}{https://wg21.link/P2408}
	\addproposal{P2520}{https://wg21.link/P2520}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1272}{https://wg21.link/P1272}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0448}{https://wg21.link/P0448}
	\addproposal{P2467}{https://wg21.link/P2467}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{p2216}{https://wg21.link/p2216}
	\addproposal{P2572}{https://wg21.link/P2572}
	\addproposal{P2419}{https://wg21.link/P2419}
	\addproposal{P2372}{https://wg21.link/P2372}
	\addproposal{p2585}{https://wg21.link/p2585}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2418}{https://wg21.link/P2418}
	\addproposal{P2286}{https://wg21.link/P2286}
	\addproposal{P2693}{https://wg21.link/P2693}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2093}{https://wg21.link/P2093}
	\addproposal{P2539}{https://wg21.link/P2539}
\end{frame}
...
\note[item]{Pas d'exception dans le code C++ avant le rétablissement du \textit{smart pointer}}
	...
	\addproposal{P1132}{https://wg21.link/P1132}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0881}{https://wg21.link/P0881}
	\addproposal{P2301}{https://wg21.link/P2301}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0627}{https://wg21.link/P0627}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0943}{https://wg21.link/P0943}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2212}{https://wg21.link/P2212}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2162}{https://wg21.link/P2162}
\end{frame}
...
\note[item]{Peut modifier aussi éventuellement le type}
	...
	\addproposal{P0798}{https://wg21.link/P0798}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P0323}{https://wg21.link/P0323}
	\addproposal{P2549}{https://wg21.link/P2549}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2505}{https://wg21.link/P2505}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P1206}{https://wg21.link/P1206}
\end{frame}

\begin{frame}[fragile]
	\frametitle{Nouveaux ranges et range adaptors}
	\begin{itemize}
		\item \mintinline{cpp}|std::views::zip()| fusionne plusieurs ranges en un range de tuple
	\end{itemize}
	...
	\begin{itemize}
		\item \mintinline{cpp}|std::views::zip_transform()| fusionnent plusieurs ranges via une transformation
	\end{itemize}
	...
	\addproposal{P2210}{https://wg21.link/P2210}
	\addproposal{p2321}{https://wg21.link/p2321}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item \mintinline{cpp}|std::views::adjacent()| construit des ranges de $N$ éléments consécutifs
		\item \mintinline{cpp}|std::views::pairwise()| construit des ranges de 2 éléments consécutifs
	\end{itemize}
	...
	\begin{itemize}
		\item \mintinline{cpp}|std::views::adjacent_transform()| et \mintinline{cpp}|std::views::pairwise_transform()| construisent un range en appliquant une transformation aux éléments adjacents
	\end{itemize}
	...
	\begin{itemize}
		\item \mintinline{cpp}|std::views::join_with()| : \mintinline{cpp}|std::views::join()| en précisant le séparateur
	\end{itemize}
	...
	\addproposal{p2321}{https://wg21.link/p2321}
	\addproposal{p2441}{https://wg21.link/p2441}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2440}{https://wg21.link/P2440}
	\addproposal{p2443}{https://wg21.link/p2443}
\end{frame}

\begin{frame}[fragile]
	\frametitle{Nouveaux ranges et range adaptors}
	\begin{itemize}
		\item \mintinline{cpp}|std::views::find_last()/find_last_if()/find_last_if_not()|
		\item \mintinline{cpp}|std::views::stride()| conserve un élément sur $n$
	\end{itemize}
	...
	\begin{itemize}
		\item \mintinline{cpp}|std::ranges::fold_left()/fold_left_first()/fold_left_with_iter()|
		\item \mintinline{cpp}|std::ranges::fold_right()/fold_right_last()/fold_right_with_iter()|
	\end{itemize}
	...
	\begin{itemize}
		\item \mintinline{cpp}|std::views::cartesian_product| : produit cartésien de plusieurs ranges
	\end{itemize}
	...
	\addproposal{P1223}{https://wg21.link/P1223}
	\addproposal{P2322}{https://wg21.link/P2322}
	\addproposal{P2374}{https://wg21.link/P2374}
	\addproposal{P2540}{https://wg21.link/P2540}
\end{frame}

\begin{frame}[fragile]
	\frametitle{Nouveaux ranges et range adaptors}
	\begin{itemize}
		\item \mintinline{cpp}|std::views::as_rvalue()| convertit les éléments en \textit{r-value}
		\item \mintinline{cpp}|std::views::as_const()| constifie les éléments
	...
	\begin{itemize}
		\item \mintinline{cpp}|std::views::enumerate()| : vue index/valeur depuis un range de valeurs
		\begin{itemize}
	...
	\begin{itemize}
		\item Améliorations de \mintinline{cpp}|std::views::split()|
		\item Corrections de \mintinline{cpp}|std::ranges::istream_view()|
	\end{itemize}
	...
	\addproposal{P2446}{https://wg21.link/P2446}
	\addproposal{p2474}{https://wg21.link/p2474}
	\addproposal{p2164}{https://wg21.link/p2164}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2017}{https://wg21.link/P2017}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2387}{https://wg21.link/P2387}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2465}{https://wg21.link/P2465}
\end{frame}
...
\begin{frame}[fragile]
	...
	\addproposal{P2502}{https://wg21.link/P2502}
	\addproposal{P2787}{https://wg21.link/P2787}
\end{frame}
\end{document}