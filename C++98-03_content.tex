...
\note[item]{multi\_pass signifie que \lstinline|a == b| implique \lstinline|++a == ++b| et qu'utiliser un itérateur sur une séquence ne modifie pas ce que référence un autre itérateur indépendant, c'est à dire que \lstinline|b=a; ++b; *a;| est équivalent à \lstinline|*a|}
		...
		\begin{column}{0.20\textwidth}
			\centering
			\adjincludegraphics[height=0.5\textheight]{input_src/C++/Iterator_hierarchie.png}
		\end{column}
	\end{columns}
